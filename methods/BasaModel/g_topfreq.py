...
if __name__ == '__main__':
    ...
    data_history = pd.read_csv(fr'C:\Users\user\NBR-Project\A-Next-Basket-Recommendation-Reality-Check\dataset\CRSP_history.csv')
    data_future = pd.read_csv(fr'C:\Users\user\NBR-Project\A-Next-Basket-Recommendation-Reality-Check\dataset\CRSP_future.csv')

    g_top_file = fr'C:\Users\user\NBR-Project\A-Next-Basket-Recommendation-Reality-Check\dataset\CRSP_pop.csv'
    ...
    with open(r'C:\Users\user\NBR-Project\A-Next-Basket-Recommendation-Reality-Check\methods\g-p-gp-topfreq\result\g_topfreq.json', 'w') as f:
